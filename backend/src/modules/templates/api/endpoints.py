...
from src.modules.templates.api.schemas.requests import (
    CreateTemplateRequest,
    UpdateTemplateRequest,
)
from src.modules.templates.api.schemas.responses import (
...
async def list_templates(
    ...
    paged = await service.list_templates(
        page=page,
        page_size=page_size,
        category=category,
        keyword=keyword,
...
async def list_my_templates(
    ...
    """获取我的模板列表 (含所有状态)。"""
    paged = await service.list_my_templates(
        current_user.id,
        page=page,
        page_size=page_size,
    )
