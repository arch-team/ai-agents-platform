...
const mockAgents: Agent[] = [
  {
    ...
    status: 'draft',
    owner_id: 1,
    config: { model_id: 'us.anthropic.claude-haiku-4-5-20251001-v1:0', temperature: 0.7, max_tokens: 4096, top_p: 1 },
  ...
  },
  {
    ...
    status: 'active',
    owner_id: 1,
    config: { model_id: 'us.anthropic.claude-haiku-4-5-20251001-v1:0', temperature: 0.5, max_tokens: 2048, top_p: 1 },
